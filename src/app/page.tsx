    ...
    <main>
          ...
          <div className="hero-grid">
            ...
            <div className="hero-card">
              ...
              <ul className="check-list">
                ...
                <li>Operational strain during growth or after acquisition</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="steps-grid">
            <div className="step-card">
              <h3>Assess</h3>
              <p>
                We review how revenue moves through your organization—from contract to cash—and identify where delays,
                inconsistencies, and breakdowns occur.
              </p>
            </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="card-grid three-up">
            <div className="info-card">
              <h3>Revenue Growing Faster Than Cash Flow</h3>
              <p>
      ...
      <section className="section section-soft">
        <div className="narrow">
          ...
          <h2 className="section-title">Selective, high-trust strategic engagements</h2>
